...
adapter_path = "/home/eknodel/QiZheng_CancerGenomics/00_misc/adapter_sequence.fa"
...
rule trim_adapters_paired_bbduk:
    input:
        ...
        fq_2 = lambda wildcards: os.path.join(config["fastq_path"], config[wildcards.sample]["fq_2"])
    output:
        out_fq_1 = "/scratch/eknodel/QiZheng_cancergenomics/trimmed_fastqs/{sample}_trimmed_read1.fastq.gz",
        out_fq_2 = "/scratch/eknodel/QiZheng_cancergenomics/trimmed_fastqs/{sample}_trimmed_read2.fastq.gz"
    params:
...
rule trimmed_fastqc_analysis:
    input:
        fq_1 = "/scratch/eknodel/QiZheng_cancergenomics/trimmed_fastqs/{sample}_trimmed_read1.fastq.gz",
        fq_2 = "/scratch/eknodel/QiZheng_cancergenomics/trimmed_fastqs/{sample}_trimmed_read2.fastq.gz"
    output:
